...
const carModels: Record<string, string[]> = {
  "Maruti Suzuki": ["Alto K10","S-Presso","Celerio","Wagon R","Ignis","Swift","Dzire","Baleno","Fronx","Brezza","Grand Vitara","Ertiga","XL6","Eeco","Jimny","Invicto","Ciaz","Victoris","e Vitara"],
  "Hyundai": ["Grand i10 Nios","i20","i20 N Line","Exter","Aura","Venue","Venue N Line","Creta","Creta N Line","Creta Electric","Alcazar","Verna","Tucson","Ioniq 5"],
  "Tata Motors": ["Tiago","Tiago NRG","Tigor","Altroz","Altroz Racer","Punch","Punch EV","Nexon","Nexon EV","Curvv","Curvv EV","Harrier","Harrier EV","Safari","Sierra"],
  "Mahindra": ["Bolero","Bolero Neo","Bolero Neo Plus","Scorpio Classic","Scorpio N","Thar","Thar ROXX","XUV 3XO","XUV 3XO EV","XUV 400","XUV 7XO","BE 6","XEV 9e"],
  "Toyota": ["Glanza","Urban Cruiser Hyryder","Urban Cruiser Taisor","Rumion","Innova Crysta","Innova HyCross","Fortuner","Fortuner Legender","Hilux","Camry","Vellfire","Land Cruiser 250","Land Cruiser 300"],
  "Kia": ["Sonet","Seltos","Carens","Carens Clavis","Carnival","EV6","EV9"],
  "Honda": ["Amaze","City","City e:HEV","Elevate"],
  "Renault": ["Kwid","Triber","Kiger"],
  "Nissan": ["Magnite","X-Trail"],
  "Skoda": ["Slavia","Kushaq","Kylaq","Kodiaq","Superb"],
  "Volkswagen": ["Virtus","Taigun","Tiguan"],
  "MG Motor": ["Comet EV","Astor","Hector","Hector Plus","Gloster","Windsor EV","ZS EV","Cyberster","Majestor"],
  ...
  "BMW": ["2 Series Gran Coupe","3 Series","5 Series","7 Series","X1","X3","X5","X7","XM","iX1","i4","i5","i7","iX"],
  "Mercedes-Benz": ["A-Class Limousine","C-Class","E-Class","S-Class","GLA","GLB","GLC","GLE","GLS","EQA","EQB","EQE","EQS","Maybach GLS","Maybach S-Class"],
  "Audi": ["A4","A6","A8 L","Q3","Q3 Sportback","Q5","Q7","Q8","S5 Sportback","RS Q8","Q8 e-tron","e-tron GT"],
  "Volvo": ["EX30","XC40","XC40 Recharge","XC60","XC90","S90","C40 Recharge","EC40"],
  ...
  "Lexus": ["ES","NX","RX","LX","LM","LC"],
  "Porsche": ["Macan","Macan Electric","Cayenne","Panamera","911","718 Cayman","718 Boxster","Taycan"],
  "MINI": ["Cooper 3 Door","Cooper 5 Door","Cooper Convertible","Countryman","Cooper Electric"],
  "Tesla": ["Model 3","Model Y"],
  "VinFast": ["VF 6","VF 7","VF 8","VF 9"],
  "Aston Martin": ["Vantage","DB12","DBX","Vanquish"],
  "Bentley": ["Bentayga","Continental GT","Flying Spur"],
  "Ferrari": ["296 GTB","296 GTS","Roma","Purosangue","12Cilindri"],
  "Lamborghini": ["Revuelto","Temerario","Urus","Urus SE"],
  "Maserati": ["Grecale","GranTurismo","GranCabrio","Ghibli","Levante"],
