...
export default function DashboardPage(){
 ...
 return <main className="dashboard-page">
  ...
  <section className="section"><div className="container">
   <div className="dashboard-hero"><div style={{position:"relative",zIndex:1}}><div className="home-kicker">YOUR CARFIX WORKSPACE</div><h1>Your car. Your answers.</h1><p>Track your assessments, review AI findings and keep every repair decision in one place.</p><div style={{display:"flex",gap:10,flexWrap:"wrap",marginTop:20}}><a className="home-primary-btn" href="/assessments/new">Start new assessment <span>→</span></a><a className="btn" href="/support">Support & grievances</a></div></div></div>
